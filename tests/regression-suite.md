...
| ⚠ **E20** | `I'm away all this week, so haircut friday at 11:00` | **KNOWN DEFECT, not fixed** — the model drops the week context from `dateExpr` AND its date is off by one day, so the weekday guard sees an arithmetic slip and the code wins with THIS week's Friday | execs 2184/2185: offered "Friday 11 Sep" to a customer who said they are away this week. Before the 2026-09-08 ruling this was dropped and re-asked. ARCH-DEC 2026-09-08c |
